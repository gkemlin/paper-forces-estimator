...
h5open("forces_TiO2.h5", "r") do file
    ...
    # write CSV
    CSV.write("forces_TiO2.csv", Tables.table([Ecut_list forces_list forces_err_list forces_res_list forces_newton_list]), writeheader=false)
    CSV.write("error_TiO2.csv", Tables.table([Ecut_list Msqrt_err_list Msqrt_res_list]), writeheader=false)
    CSV.write("diff_forces_TiO2.csv", Tables.table([Ecut_list diff_forces_err_list diff_forces_res_list diff_forces_newton_list]), writeheader=false)
end
